  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative bg-[#0a0a0a] overflow-hidden">
        ...
        <div className="container mx-auto px-4 pt-24 pb-32 md:pt-32 md:pb-40 max-w-7xl relative z-10 text-center">
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-md border border-white/20 text-[#F8C21C] px-4 py-1.5 rounded-full text-sm font-semibold mb-6">
            <Star size={14} fill="currentColor" />
            <span>{post.category}</span>
          </div>
          <h1 className="text-3xl md:text-5xl lg:text-6xl font-extrabold text-white mb-6 tracking-tight leading-tight max-w-4xl mx-auto">
            {post.title}
          </h1>
          {post.location && (
            <div className="inline-flex items-center gap-2 text-white/80 text-lg">
              <MapPin size={20} className="text-[#F8C21C]" />
      ...
      <div className="container mx-auto px-4 relative z-20 -mt-24 max-w-6xl">
