...
export default function Hero(): JSX.Element {
  ...
  return (
    <section id="home-banner" className="relative overflow-x-hidden">
      {/* Background Section */}
      <div className="bg-[#F8F4E6] relative py-2 lg:py-4 pb-24 md:pb-28 xl:pb-32">
          ...
          <div className="pb-4 md:pb-20 xl:pb-24 2xl:pb-32">
            <div className="pt-4 md:pt-4 pb-4 md:pb-6 text-center md:text-left">
              <div className="relative z-10">
                <h1 className="text-[32px] md:text-[38px] font-bold font-montserrat text-[#8B0000] lg:text-[56px] lg:leading-[64px]">
                  Buy Homes Directly <br />
                  <span className="text-[#005E60]">With Builders</span>
                </h1>
              </div>
            </div>

            {/* Badges */}
            <div className="bg-[#F8C21C]/10 p-4 w-full sm:w-auto rounded-full inline-flex justify-center items-center gap-2 sm:gap-4 relative z-20 border border-[#F8C21C]/30">
              <div className="flex gap-2">
                ...
                />
                <h2 className="font-jost font-semibold text-[#005E60] text-[14px] md:text-[18px]">
                  No Brokerage
                </h2>
              </div>
              <div className="w-[1px] h-5 md:h-7 bg-[#005E60] rounded-full" />
              <div className="flex gap-2">
                <img
                  alt=""
      ...
      <div className="w-full lg:max-w-[1280px] mx-auto px-4 absolute left-1/2 -translate-x-1/2 -translate-y-2/5 md:-translate-y-1/2 lg:w-[85%] z-30">
        <div className="flex flex-col md:flex-row md:items-end">
            ...
            <div className="flex flex-col gap-0 w-full">
              ...
              >
                ...
                <button
                  ...
                  className={`inline-flex flex-1 items-center justify-center gap-1.5 rounded-md px-2 py-1 font-medium whitespace-nowrap transition-all cursor-pointer border-0 text-[16px] h-12 border-b-3 rounded-t-2xl ${
                    propertyType === "apartments"
                      ? "text-[#005E60] bg-[#005E60]/10 border-b-3 border-[#005E60]"
                ...
                <button
                  ...
                  disabled
                  className={`inline-flex flex-1 items-center justify-center gap-1.5 rounded-md px-2 py-1 font-medium whitespace-nowrap transition-all cursor-not-allowed border-0 text-[16px] h-12 border-b-3 rounded-t-2xl disabled:opacity-60 ${
                    propertyType === "plots"
                      ? "text-[#005E60] bg-[#005E60]/10 border-b-3 border-[#005E60]"
                      : "text-[#9e9e9e] bg-white border-b-3 border-[#9e9e9e]"
                  }`}
                >
                  ...
                  Plots
                  <span className="text-[10px] rounded text-white font-semibold absolute -top-2 -right-2 py-0.5 px-1.5 bg-[linear-gradient(to_right,_#8B0000,_#005E60)] animate-pulse tracking-wider z-10">
                    Coming Soon
                  </span>
                </button>
              </div>
              ...
              {/* Search Input Area */}
              <div className="bg-white md:rounded-bl-2xl py-2 px-4 mt-3 h-auto md:h-32 xl:h-40 border-t-2 border-[#F8C21C]">
                    ...
                    <div className="w-full relative">
                      <div className="relative">
                        <input
                          ...
                          className="w-full bg-[#F8F4E6] text-[14px] md:text-[16px] py-3 px-3 pr-10 rounded-lg border-none focus:outline-none focus:ring-2 focus:ring-[#005E60] placeholder:text-[#9e9e9e]"
                        />
                        <svg
                          ...
                          className="absolute right-3 top-1/2 -translate-y-1/2 cursor-pointer size-4"
                  ...
                  <div className="flex flex-wrap gap-2">
                    {["Kharghar", "Panvel", "Navi Mumbai", "Thane"].map((loc) => (
                      <button
                        ...
                        className="text-[12px] md:text-[14px] px-3 py-1 bg-[#F8C21C]/20 text-[#8B0000] rounded-full hover:bg-[#8B0000] hover:text-white transition-colors font-medium"
                      >
                        {loc}
                      </button>
                    ))}
          ...
          <div className="flex-1 bg-white p-4 md:px-8 h-auto md:h-32 xl:h-40 md:border-l md:rounded-tr-2xl rounded-br-2xl rounded-bl-2xl md:rounded-bl-none grid place-items-center -mt-2 md:mt-0 border-t-2 md:border-t-0 border-[#F8C21C]">
            <button
              onClick={handleSearch}
              className="bg-[#005E60] hover:bg-[#004a4c] text-white px-8 py-3 rounded-full font-semibold text-[16px] transition-colors shadow-md hover:shadow-lg w-full md:w-auto border-2 border-[#005E60] hover:border-[#8B0000]"
            >
              Search Properties
            </button>
          </div>
