...
export default function CtaFormSection() {
  ...
  const COLORS = {
    ...
    bgDark: '#003d40',     // Darker teal for gradients
  };
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              ...
              <span className="text-[#F8C21C]">Expert Guidance</span>
            </motion.h2>
            ...
            >
              Let our property experts shortlist the best options tailored to your needs. 
            ...
            >
              {[
                { icon: Phone, label: 'Call Us', value: '+91 87435 63546', href: 'tel:+918743563546' },
                { icon: Mail, label: 'Email', value: '8743563546@noemail.paradise.com', href: 'mailto:8743563546@noemail.paradise.com' },
                { icon: MapPin, label: 'Visit', value: 'Pune & Mumbai Offices', href: '/contact' }
              ].map((item, index) => (
                <motion.a
                  key={item.label}
                  variants={itemVariants}
                ...
                <>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <select
                          ...
                          onChange={handleChange}
                          className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#005E60] focus:border-transparent transition-all bg-gray-50 hover:bg-white appearance-none"
                        >
                    ...
                    <p className="text-xs text-gray-400 text-center">
                      ...
                      <a href="/privacy" className="text-[#005E60] hover:underline">Privacy Policy</a>. 
