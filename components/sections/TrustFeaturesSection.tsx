  ...
  return (
    <>
            ...
            >
              ...
              >
                {features.map((feature, index) => (
                  <motion.div
                    ...
                    className="group relative p-5 bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-xl hover:border-[#005E60]/30 transition-all duration-300"
                  >
              ...
              >
                <button 
                  ...
                  className="group inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-[#005E60] to-[#004a4d] text-white font-semibold rounded-xl hover:from-[#004a4d] hover:to-[#003537] transition-all duration-300 shadow-lg hover:shadow-xl hover:shadow-[#005E60]/25 focus:outline-none focus:ring-2 focus:ring-[#005E60] focus:ring-offset-2"
      ...
      <EnquiryPopup
        ...
        projectName={`Properties in ${city}`}
        projectTagline="Get exclusive deals & personalized guidance"
        ...
        trackingData={{
          ...
          campaign: `city_${city.toLowerCase()}`,
          medium: 'website'
        }}
      />
    </>
