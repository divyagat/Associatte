...
const services = [
  { id: 'consultation', icon: Handshake, title: 'Property Consultation', shortDesc: 'Expert guidance to find your perfect property', color: BRAND.green, gradient: 'from-[#005E60] to-[#004a4d]', href: '/services#consultation' },
  { id: 'home-loans', icon: FileText, title: 'Home Loans', shortDesc: 'Best loan deals with minimal paperwork', color: BRAND.yellow, gradient: 'from-[#F8C21C] to-[#d4a017]', href: '/services#home-loans' },
  { id: 'legal', icon: Scale, title: 'Legal Assistance', shortDesc: 'Hassle-free transactions with legal experts', color: BRAND.red, gradient: 'from-[#8B0000] to-[#6a0000]', href: '/services#legal' },
  { id: 'management', icon: ClipboardList, title: 'Property Management', shortDesc: 'Professional management while you relax', color: BRAND.yellow, gradient: 'from-[#F8C21C] to-[#d4a017]', href: '/services#management' },
  { id: 'investment', icon: TrendingUp, title: 'Investment Advisory', shortDesc: 'Data-driven strategies for maximum ROI', color: BRAND.red, gradient: 'from-[#8B0000] to-[#6a0000]', href: '/services#investment' },
];

export default function ServicesSection({ city }: ServicesSectionProps) {
  return (
