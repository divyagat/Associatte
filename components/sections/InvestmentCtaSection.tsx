  ...
  return (
    <section className="py-16 relative overflow-hidden">
      <div className="absolute inset-0">
        <img src="https://images.unsplash.com/photo-1514565131-fce0801e5785?w=1920&q=80" alt="City Skyline" className="w-full h-full object-cover" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl">
          ...
          <button className="bg-yellow-500 text-gray-900 px-8 py-3 rounded-md font-semibold hover:bg-yellow-600 transition-colors flex items-center gap-2">
            Get Investment Consultation <ChevronRight className="w-5 h-5" />
          </button>
        </div>
      </div>
    </section>
