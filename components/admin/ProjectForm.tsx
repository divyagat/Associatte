    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input type="text" name="name" value={formData.name} onChange={handleChange} required className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#005E60]" />
          </div>
          <div>
          ...
          <div>
            ...
            <select name="location" value={formData.location} onChange={handleChange} required className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#005E60]">
          ...
          <div>
            ...
            <input type="text" name="priceDetails.range" value={formData.priceDetails.range} onChange={handleChange} placeholder="₹80 Lakh - ₹1.15 Cr" required className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#005E60]" />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">RERA Number *</label>
            <input type="text" name="reraNumber" value={formData.reraNumber} onChange={handleChange} required className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#005E60]" />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">Possession Date *</label>
            <input type="text" name="possessionDate" value={formData.possessionDate} onChange={handleChange} placeholder="Dec 2026" required className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#005E60]" />
          </div>
          ...
          <div className="md:col-span-2">
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-200">
              <div>
                ...
                <p className="text-xs text-gray-500">This project will be marked as unavailable on the website.</p>
              </div>
              <button
                type="button"
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input type="text" name="fullLocation.area" value={formData.fullLocation.area} onChange={handleChange} required className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#005E60]" />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">City *</label>
            <input type="text" name="fullLocation.city" value={formData.fullLocation.city} onChange={handleChange} required className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#005E60]" />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">State</label>
            <input type="text" name="fullLocation.state" value={formData.fullLocation.state} onChange={handleChange} className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#005E60]" />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">Pincode</label>
            <input type="text" name="fullLocation.pincode" value={formData.fullLocation.pincode} onChange={handleChange} className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#005E60]" />
          </div>
          <div className="md:col-span-2">
            <label className="block text-sm font-medium text-gray-700 mb-2">Landmark</label>
            <input type="text" name="fullLocation.landmark" value={formData.fullLocation.landmark} onChange={handleChange} className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#005E60]" />
          </div>
        </div>
      </div>
        ...
        <div className="space-y-4">
          <div>
            ...
            <div className="flex items-center gap-4">
              {formData.image && <img src={formData.image} alt="Main" className="w-32 h-32 object-cover rounded-lg" />}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4 border-t border-gray-200">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Master Plan Image</label>
              <div className="flex items-center gap-4">
                {formData.masterPlan && <img src={formData.masterPlan} alt="Master Plan" className="w-24 h-24 object-cover rounded-lg" />}
                <label className="flex-1 cursor-pointer">
                  <div className="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center hover:border-[#005E60] transition-colors">
                    <Upload className="mx-auto mb-1 text-gray-400" size={20} />
                    <p className="text-xs text-gray-600">Upload master plan</p>
                    <input type="file" accept="image/*" onChange={(e) => handleImageUpload(e, 'masterPlan')} className="hidden" />
                  </div>
                </label>
              </div>
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Location Map Image</label>
              <div className="flex items-center gap-4">
                {formData.locationMap && <img src={formData.locationMap} alt="Location Map" className="w-24 h-24 object-cover rounded-lg" />}
                <label className="flex-1 cursor-pointer">
                  <div className="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center hover:border-[#005E60] transition-colors">
                    <Upload className="mx-auto mb-1 text-gray-400" size={20} />
                    <p className="text-xs text-gray-600">Upload location map</p>
                    <input type="file" accept="image/*" onChange={(e) => handleImageUpload(e, 'locationMap')} className="hidden" />
                  </div>
                </label>
              </div>
            </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input type="text" name="developer.name" value={formData.developer.name} onChange={handleChange} required className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#005E60]" />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">Established Year</label>
            <input type="text" name="developer.established" value={formData.developer.established} onChange={handleChange} className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#005E60]" />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">Total Projects Count</label>
            <input type="number" name="developer.projectsCount" value={formData.developer.projectsCount} onChange={handleChange} className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#005E60]" />
          </div>
          <div className="md:col-span-2">
            <label className="block text-sm font-medium text-gray-700 mb-2">Developer Description</label>
            <textarea name="developer.description" value={formData.developer.description} onChange={handleChange} rows={3} className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#005E60]" />
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-lg font-bold text-gray-900">Configurations (Unit Types)</h2>
          <button type="button" onClick={addConfiguration} className="flex items-center gap-2 px-3 py-1.5 bg-[#005E60] text-white rounded-lg hover:bg-[#004a4d] transition-colors text-sm">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <button type="button" onClick={addFloorPlan} className="flex items-center gap-2 px-3 py-1.5 bg-[#005E60] text-white rounded-lg hover:bg-[#004a4d] transition-colors text-sm">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        ...
        <div className="flex gap-2 mb-3">
          <input type="text" value={currentAmenity} onChange={(e) => setCurrentAmenity(e.target.value)} onKeyPress={(e) => e.key === 'Enter' && (e.preventDefault(), addAmenity())} placeholder="Add amenity (e.g., Swimming Pool)" className="flex-1 px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#005E60]" />
          <button type="button" onClick={addAmenity} className="px-4 py-2 bg-[#005E60] text-white rounded-lg hover:bg-[#004a4d] transition-colors">Add</button>
        </div>
        <div className="flex flex-wrap gap-2">
          {formData.amenities.map((amenity: string, index: number) => (
            <div key={index} className="flex items-center gap-2 px-3 py-1.5 bg-[#005E60]/10 text-[#005E60] rounded-lg">
              ...
              <button type="button" onClick={() => removeAmenity(index)} className="hover:text-red-600 transition-colors">
                <X size={14} />
              </button>
            </div>
          ))}
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        ...
        <p className="text-xs text-gray-500 mb-4">Extra words visitors might type to find this project (e.g., area nicknames, nearby landmarks, builder aliases, "2bhk", "sea view"). These make the project show up in the site search even if the words aren&apos;t in its name or location.</p>
        <div className="flex gap-2 mb-3">
          <input type="text" value={currentKeyword} onChange={(e) => setCurrentKeyword(e.target.value)} onKeyPress={(e) => e.key === 'Enter' && (e.preventDefault(), addKeyword())} placeholder="Add keyword and press Enter" className="flex-1 px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#005E60]" />
          <button type="button" onClick={addKeyword} className="px-4 py-2 bg-[#005E60] text-white rounded-lg hover:bg-[#004a4d] transition-colors">Add</button>
        </div>
        <div className="flex flex-wrap gap-2">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <button type="button" onClick={addNearbyPlace} className="flex items-center gap-2 px-3 py-1.5 bg-[#005E60] text-white rounded-lg hover:bg-[#004a4d] transition-colors text-sm">
      ...
      {/* EMI Details */}
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        <h2 className="text-lg font-bold text-gray-900 mb-4">EMI Details</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">Starting From</label>
            <input type="text" name="emi.startingFrom" value={formData.emi.startingFrom} onChange={handleChange} placeholder="₹25,000/month" className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#005E60]" />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">Down Payment</label>
            <input type="text" name="emi.downPayment" value={formData.emi.downPayment} onChange={handleChange} placeholder="10%" className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#005E60]" />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">Interest Rate</label>
            <input type="text" name="emi.interestRate" value={formData.emi.interestRate} onChange={handleChange} placeholder="8.5%" className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#005E60]" />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">Tenure</label>
            <input type="text" name="emi.tenure" value={formData.emi.tenure} onChange={handleChange} placeholder="Up to 30 years" className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#005E60]" />
          </div>
        </div>
      </div>
      ...
      {/* About */}
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        <h2 className="text-lg font-bold text-gray-900 mb-4">About Project *</h2>
        <textarea name="about" value={formData.about} onChange={handleChange} rows={6} required placeholder="Write detailed description about the project..." className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#005E60]" />
      </div>

      {/* Submit Button */}
      <div className="flex items-center justify-end gap-3">
        <button type="button" onClick={() => window.history.back()} className="px-6 py-2.5 border border-gray-200 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors">Cancel</button>
        <button type="submit" disabled={loading} className="px-6 py-2.5 bg-[#005E60] text-white rounded-lg hover:bg-[#004a4d] transition-colors disabled:opacity-50">
